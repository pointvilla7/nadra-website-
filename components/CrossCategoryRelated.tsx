...
const TOPICAL_BRIDGES: Record<string, string[]> = {
  nadra: [
    ...
    '/family-registration/family-registration-certificate-frc-apply',
  ],
  passport: [
    '/nadra/cnic-kaise-banaye',
    '/nadra/nicop-fee-calculator',
    '/overseas/opf-membership-card-benefits-2026',
    '/traffic/driving-license-online-apply-renewal-dlims-2026',
  ],
  welfare: [
    '/nadra/b-form-frc-status-check',
    '/health/sehat-card-eligibility-checker-2026',
    '/loans/government-loan-emi-calculator-2026',
    '/welfare/pser-survey-status-checker-2026',
  ],
  loans: [
    '/finance/withholding-tax-rates-filers-non-filers',
  ...
  bills: [
    ...
    '/finance/iban-validator-pakistan-2026',
    '/bills/utility-bill-checker-2026',
  ],
  jobs: [
    '/education/hec-degree-attestation-process-pakistan-2026',
    '/nadra/cnic-kaise-banaye',
    '/certificates/domicile-certificate-online-apply-punjab-sindh-kp-2026',
    '/tax/how-to-become-tax-filer-pakistan-2026',
  ],
  education: [
    '/welfare/laptop-scheme-registration',
    '/jobs/fpsc-online-apply-step-by-step',
    '/certificates/domicile-certificate-online-apply-punjab-sindh-kp-2026',
    '/nadra/b-form-frc-status-check',
  ],
  traffic: [
  ...
  tax: [
    ...
    '/business/secp-company-registration-online-guide-2026',
  ...
  'family-registration': [
    '/nadra/family-registration-certificate-frc-apply',
    '/nadra/b-form-frc-status-check',
    '/certificates/birth-certificate-union-council-online-apply-2026',
  ...
  certificates: [
    '/nadra/cnic-kaise-banaye',
    '/education/hec-degree-attestation-process-pakistan-2026',
    '/legal/police-character-certificate-online-punjab',
  ...
  legal: [
    '/certificates/police-character-certificate-online-punjab',
    '/property/punjab-land-record-fard-verifier-2026',
    '/nadra/b-form-frc-status-check',
    '/tax/fbr-active-taxpayer-status-helper-2026',
  ],
  ...
  'pakistan-post': [
    ...
    '/nadra/cnic-kaise-banaye',
    '/bills/utility-bill-checker-2026',
    '/education/roll-number-slip-checker',
  ],
  finance: [
    '/tax/income-tax-calculator-salaried-2026',
    '/loans/government-loan-emi-calculator-2026',
