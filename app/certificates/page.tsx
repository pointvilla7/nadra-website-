...
export const metadata: Metadata = {
  title: 'Birth, Death & Domicile | Pakistan Info Hub',
  description: 'Official guidance for issuing NADRA computerized birth certificates, online domicile certificates, PRC, and death reporting.',
  openGraph: {
    title: 'Birth, Death & Domicile | Pakistan Info Hub',
    description: 'Official guidance for issuing NADRA computerized birth certificates, online domicile certificates, PRC, and death reporting.',
    images: [{ url: 'https://www.pakistaninfohub.com/og-default.jpg', width: 1200, height: 630 }],
    url: 'https://www.pakistaninfohub.com/certificates',
  },
  alternates: {
    canonical: 'https://www.pakistaninfohub.com/certificates',
  },
};

export default function Page() {
  const category = CATEGORIES.find((c) => c.slug === 'certificates') || CATEGORIES[0];
  const articles = Object.values(ARTICLES).filter((a) => a.categoryId === 'certificates');
    ...
    <>
      <SchemaInjector
        customSchema={{
          ...
          '@type': 'CollectionPage',
          name: 'Birth, Death & Domicile | Pakistan Info Hub',
          url: 'https://www.pakistaninfohub.com/certificates',
          description: 'Official guidance for issuing NADRA computerized birth certificates, online domicile certificates, PRC, and death reporting.',
        }}
      />
        ...
        <header className="bg-doc-paper dark:bg-doc-dark-card border-2 border-doc-brass/40 rounded-3xl p-6 sm:p-8 md:p-10 shadow-sm relative overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            ...
            <div className="md:col-span-4 flex justify-center">
              <CategoryHeroIllustration category="certificates" />
            </div>
          </div>
        </header>
