      ...
      <div className="space-y-10 md:space-y-14 animate-fadeIn font-sans">
        ...
        <section className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            >
              <span className="text-xs font-mono text-doc-brass font-bold uppercase block">Overseas Wire</span>
              <h3 className="font-serif font-bold text-sm text-doc-ink dark:text-white group-hover:text-doc-seal mt-1">
                Roshan Digital Account 2026 →
              </h3>
              <p className="text-xs text-slate-500 mt-1">SBP digital account for NRPs, foreigners, and remittance IBANs.</p>
            </Link>
