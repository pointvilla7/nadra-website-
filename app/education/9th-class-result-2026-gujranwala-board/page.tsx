...
const BOARD_SLUG = '9th-class-result-2026-gujranwala-board';
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'bise gujranwala 9th result 2026',
    'class 9 result gujranwala board',
    'bise grw roll number check',
    'gujranwala board 9th result sms code 800299',
    'bisegrw.edu.pk',
  ],
  openGraph: {
    title: board.metaTitle,
