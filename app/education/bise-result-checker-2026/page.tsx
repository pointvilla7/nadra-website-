    ...
    <>
      ...
      <div className="space-y-10 md:space-y-14 animate-fadeIn">
        ...
        <DirectAnswerBox
          ...
          answerEn="9th Class (SSC Part-I) Annual Results 2026 across Punjab boards were officially announced on Wednesday, September 2, 2026 at 10:00 AM and are available for live checking. To check: (1) Select your board below or use the dedicated board link, (2) click the official portal link and enter your Roll Number, or (3) for instant lookup when servers are busy, send your Roll Number via SMS to your board's verified code (e.g. 800291 for Lahore, 800240 for Faisalabad, 800296 for Rawalpindi, 800290 for Sargodha, 800299 for Gujranwala, 5050 for FBISE / AJK)."
          answerUr="پنجاب کے تمام تعلیمی بورڈز نے نہم کلاس (9th) سالانہ رزلٹ 2026 کا باقاعدہ اعلان 2 ستمبر 2026 کو صبح 10:00 بجے کر دیا ہے اور نتائج آن لائن دستیاب ہیں۔ رزلٹ چیک کرنے کے 2 طریقے ہیں: (1) نیچے اپنا بورڈ منتخب کر کے سرکاری ویب سائٹ پر رول نمبر درج کریں، یا (2) سرور ڈاؤن ہونے کی صورت میں اپنے بورڈ کے مخصوص کوڈ پر رول نمبر بذریعہ SMS بھیجیں (مثلاً لاہور 800291، فیصل آباد 800240، راولپنڈی 800296، سرگودھا 800290، گوجرانوالہ 800299)۔"
        />
