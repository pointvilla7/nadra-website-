    ...
    step: [
      {
        ...
        url: 'https://www.pakistaninfohub.com/passport/tracking-status#step-1',
      },
      {
        '@type': 'HowToStep',
        position: 2,
        ...
        url: 'https://www.pakistaninfohub.com/passport/tracking-status#step-2',
      },
      {
        '@type': 'HowToStep',
        position: 3,
        ...
        url: 'https://www.pakistaninfohub.com/passport/tracking-status#step-3',
      },
    ],
  };
