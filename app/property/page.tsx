...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.pakistaninfohub.com/property',
  },
};

export default function Page() {
  const category = CATEGORIES.find((c) => c.slug === 'property') || CATEGORIES[0];
  const articles = Object.values(ARTICLES).filter((a) => a.categoryId === 'property');
        ...
        <header className="bg-doc-paper dark:bg-doc-dark-card border-2 border-doc-brass/40 rounded-3xl p-6 sm:p-8 md:p-10 shadow-sm relative overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            ...
            <div className="md:col-span-4 flex justify-center">
              <CategoryHeroIllustration category="property" />
            </div>
          </div>
        </header>
