...
export const metadata: Metadata = {
  ...
  description: "Check BISP 8171 portal eligibility online 2026 by 13-digit CNIC. View current Benazir Kafaalat payment amount (check via 8171 portal), Taleemi Wazaif stipend, and NSER survey status.",
  openGraph: {
    title: "BISP 8171 Portal 2026: Check Eligibility by CNIC Online & Payment Date | Pakistan Info Hub",
    description: "Check BISP 8171 portal eligibility online 2026 by 13-digit CNIC. View current Benazir Kafaalat payment amount (check via 8171 portal), Taleemi Wazaif stipend, and NSER survey status.",
